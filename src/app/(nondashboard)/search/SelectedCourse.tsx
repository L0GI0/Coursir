/* Component included in the path as it isn't use in any other place */
    ...
    <div className="selected-course">
        <div>
            ...
            <p className="selected-course__author">
                ...
                <span className="selected-course__entrollment-count">
        ...
        <div className="selected-course__content">
            ...
            <div className="selected-course__selections">
