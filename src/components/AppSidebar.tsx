                        ...
                        <div className="app-sidebar__logo-container group">
                            <div className="app-sidebar__logo-wrapper">
                                <Image
                                    ...
                                    width={25}
                                    height={20}
                                    className="app-sizebar__logo"
                                />
                                <p className="app-sidebar__title">COURSIR</p>
                            </div>
                        ...
                        >
                            <SidebarMenuButton asChild size="lg" className={cn("app-sidebar__nav-button", !isActive && "text-customgreys-dirtyGrey")}>
                                <Link href={link.href} className="app-sizebar__nav-link">
                                    ...
                                    />
                                    <span className={cn("app-sidebar__nav-text", isActive ? "text-white-50" : "text-grey-500")}>{link.label}</span>
                                </Link>
                            </SidebarMenuButton>
